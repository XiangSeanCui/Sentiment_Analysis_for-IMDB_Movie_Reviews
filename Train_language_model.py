...
parser = argparse.ArgumentParser(description='PyTorch Language Training')
parser.add_argument('--resume', '-r', default = "./checkpoint.pth.tar", help='Resume from checkpoint')
parser.add_argument('--num_epochs', '-n', default=100, type=int, help='total epoch')
...
if args.resume:
    ...
    if os.path.isfile(args.resume):
        ...
        test_accu = checkpoint['test_accu']
...
df_train.to_csv("result_train.csv", index=False)
df_test.to_csv("result_test.csv", index=False)
